...
export default function Project() {
  const projects = [
    {
      id: 1,
      title: "Saving habit tracker",
      description: "A simple project by using python libraries.",
      technologies: ["streamlit", "pandas", "scikit-learn"],
    },
    {
      id: 2,
    ...
    },
    {
      ...
      title: "Gym App",
      description:
        "All-in-one fitness app for workouts, tracking, and memberships.",
      link: "https://example.com",
      technologies: ["Html", "Bootstrap", "SQL", "PHP"],
    },
  ];
